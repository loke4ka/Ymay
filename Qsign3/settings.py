...
SECRET_KEY = 'django-insecure-b_y*_9c5(x$#ggnhwzh9od7f)*m=kyt)d-)k=4qofkk5%o@_&8'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'cache/reset_password',  # Относительный путь относительно manage.py проекта
    }
}
...
CSRF_TRUSTED_ORIGINS = ['https://ymay.fun']
